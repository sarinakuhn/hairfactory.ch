...
if(!isset($_POST['name']) || !isset($_POST['vorname']) || !isset($_POST['telefon']) || !isset($_POST['email']) || !isset($_POST['datum']) || !isset($_POST['uhrzeit'])) {
	header("Location: wallisellen_reservation.html");
	exit;
}
?>
...
<body>
	...
	$subject = "Reservation von der Internetseite www.hairfactory.ch - Wallisellen"; 
...
Reservation:\n$text";
	...
	header("Location: wallisellen_reservation_thanks.html");
	?>
</body>
</html>