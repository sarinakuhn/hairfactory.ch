...
if(!isset($_POST['name']) || !isset($_POST['vorname']) || !isset($_POST['telefon']) || !isset($_POST['email']) || !isset($_POST['datum']) || !isset($_POST['uhrzeit'])) {
	header("Location: uster_bankstrasse_reservation.html");
	exit;
}
?>
...
<body>
	...
	$subject = "Reservation von der Internetseite www.hairfactory.ch - Uster Bankstrasse"; 
...
Reservation:\n$text";
	...
	header("Location: uster_bankstrasse_reservation_thanks.html");
	?>
</body>
</html>