...
if(!isset($_POST['name']) || !isset($_POST['vorname']) || !isset($_POST['telefon']) || !isset($_POST['email'])) {
	header("Location: uster_bankstrasse_kontakt.html");
	exit;
}
?>
...
<body>
	...
	$subject = "Feedback von der Internetseite www.hairfactory.ch - Uster Bankstrasse"; 
...
Nachricht:\n$text";
	...
	header("Location: uster_bankstrasse_kontakt_thanks.html");
	?>
</body>
</html>